...
ActiveRecord::Schema.define(version: 2019_12_10_221748) do
  ...
  create_table "likes", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "politest_type"
    t.bigint "politest_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["politest_type", "politest_id"], name: "index_likes_on_politest_type_and_politest_id"
  end
